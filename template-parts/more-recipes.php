<?php
/**
 * Adds new shortcode "More Recipes" and registers it to
 * the Visual Composer plugin
 *
 */
if ( ! class_exists( 'VS_More_Recipes_Shortcode' ) ) {

    class VS_More_Recipes_Shortcode
    {
        ...
        public function __construct()
        {
            ...
            add_shortcode('vs_more_recipes', __CLASS__ . '::output');

            // Map shortcode to WPBakery so you can access it in the builder
            if (function_exists('vc_lean_map')) {
                vc_lean_map('vs_more_recipes', __CLASS__ . '::map');
            }
        }
        ...
        {
            $atts = vc_map_get_attributes('vs_more_recipes', $atts);
...
//                'post__not_in' => array( get_queried_object_id() ),
            ...
            $output .= '<div class="more-recipes related-items " ' . $moduleSize .  ' >';
                $output .= '<h3>' . $title . '</h3>';
            ...
            $output .= '';
                    ...
                    if($post_query->have_posts() ) {
                        while ($post_query->have_posts()) {
                            ...
                            $output .= '<div class="related-img-wrap">';
        ...
        {
            return array(
                'name' => esc_html__('More Recipes', 'locale'),
                'description' => esc_html__('Shows the More Recipes', 'locale'),
                'base' => 'vs_more_recipes',
                'params' => array(
