<?php
/**
 * Adds new shortcode "Snack Options" and registers it to
 * the Visual Composer plugin
 *
 */
if ( ! class_exists( 'VS_Snack_Options_Shortcode' ) ) {

    class VS_Snack_Options_Shortcode
    {
        ...
        public function __construct()
        {
            ...
            add_shortcode('vs_snack_options', __CLASS__ . '::output');

            // Map shortcode to WPBakery so you can access it in the builder
            if (function_exists('vc_lean_map')) {
                vc_lean_map('vs_snack_options', __CLASS__ . '::map');
            }
        }
        ...
        {
            $atts = vc_map_get_attributes('vs_snack_options', $atts);
...
{
    return array(
        'name' => esc_html__('Snack Options', 'locale'),
        'description' => esc_html__('Shows the Snack Options', 'locale'),
        'base' => 'vs_snack_options',
        'params' => array(
...
new VS_Snack_Options_Shortcode;